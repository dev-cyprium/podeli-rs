    ...
    <div className="min-h-screen bg-stone-50 font-sans text-slate-900 selection:bg-amber-100 selection:text-amber-900">
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <h1 className="max-w-4xl text-5xl font-extrabold tracking-tight text-slate-900 sm:text-6xl lg:text-7xl">
              ...
              <span className="relative whitespace-nowrap text-amber-500">
                <svg className="absolute -bottom-2 left-0 -z-10 h-3 w-full fill-amber-200" viewBox="0 0 100 10" preserveAspectRatio="none">
            ...
            <div className="mt-10 w-full max-w-2xl">
              ...
              <div className="mt-4 flex flex-wrap justify-center gap-2 text-sm text-slate-500">
                <span>Popularno:</span>
                <span className="cursor-pointer font-medium text-slate-700 hover:text-amber-600 hover:underline">Alati</span>
                <span className="cursor-pointer font-medium text-slate-700 hover:text-amber-600 hover:underline">Kampovanje</span>
                <span className="cursor-pointer font-medium text-slate-700 hover:text-amber-600 hover:underline">Elektronika</span>
                <span className="cursor-pointer font-medium text-slate-700 hover:text-amber-600 hover:underline">Društvene igre</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="ponuda" className="py-16 sm:py-24">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="flex flex-col items-center justify-between gap-4 sm:flex-row">
            ...
            <a href="#" className="text-sm font-semibold text-amber-600 hover:text-amber-700">
          ...
          <div className="mt-10 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div className="group relative overflow-hidden rounded-2xl bg-white shadow-md transition-all hover:-translate-y-1 hover:shadow-xl">
              <div className="flex h-48 w-full items-center justify-center bg-slate-100 transition-colors group-hover:bg-amber-50">
                <Drill className="h-20 w-20 text-slate-300 group-hover:text-amber-500" strokeWidth={1.5} />
              </div>
              <div className="p-5">
                <div className="mb-2 flex items-start justify-between">
                  <h3 className="font-semibold text-slate-900">Bosch Bušilica</h3>
                  <span className="rounded-full bg-slate-100 px-2 py-1 text-xs font-bold text-slate-600">Alati</span>
                </div>
                ...
                <div className="mt-4 flex items-center justify-between border-t border-slate-100 pt-4">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs font-medium text-slate-600">Marko P.</span>
                  </div>
                  <span className="font-bold text-amber-600">500 RSD<span className="text-xs font-normal text-slate-400">/dan</span></span>
                </div>
              </div>
            </div>
            ...
            <div className="group relative overflow-hidden rounded-2xl bg-white shadow-md transition-all hover:-translate-y-1 hover:shadow-xl">
              <div className="flex h-48 w-full items-center justify-center bg-slate-100 transition-colors group-hover:bg-amber-50">
                <Tent className="h-20 w-20 text-slate-300 group-hover:text-amber-500" strokeWidth={1.5} />
              </div>
              <div className="p-5">
                <div className="mb-2 flex items-start justify-between">
                  <h3 className="font-semibold text-slate-900">Šator za 4 osobe</h3>
                  <span className="rounded-full bg-slate-100 px-2 py-1 text-xs font-bold text-slate-600">Kampovanje</span>
                </div>
                <div className="flex items-center gap-2 text-sm text-slate-500">
                  <MapPin className="h-3 w-3" />
                ...
                <div className="mt-4 flex items-center justify-between border-t border-slate-100 pt-4">
                  <div className="flex items-center gap-2">
                    <div className="h-6 w-6 rounded-full bg-slate-200"></div>
                    <span className="text-xs font-medium text-slate-600">Jelena M.</span>
                  </div>
                  <span className="font-bold text-amber-600">800 RSD<span className="text-xs font-normal text-slate-400">/dan</span></span>
                </div>
              </div>
            </div>
            ...
            <div className="group relative overflow-hidden rounded-2xl bg-white shadow-md transition-all hover:-translate-y-1 hover:shadow-xl">
              <div className="flex h-48 w-full items-center justify-center bg-slate-100 transition-colors group-hover:bg-amber-50">
                <Gamepad2 className="h-20 w-20 text-slate-300 group-hover:text-amber-500" strokeWidth={1.5} />
              </div>
              <div className="p-5">
                <div className="mb-2 flex items-start justify-between">
                  <h3 className="font-semibold text-slate-900">PS5 + 2 džojstika</h3>
                  <span className="rounded-full bg-slate-100 px-2 py-1 text-xs font-bold text-slate-600">Zabava</span>
                </div>
                <div className="flex items-center gap-2 text-sm text-slate-500">
                  <MapPin className="h-3 w-3" />
                ...
                <div className="mt-4 flex items-center justify-between border-t border-slate-100 pt-4">
                  <div className="flex items-center gap-2">
                    <div className="h-6 w-6 rounded-full bg-slate-200"></div>
                    <span className="text-xs font-medium text-slate-600">Stefan K.</span>
                  </div>
                  <span className="font-bold text-amber-600">2000 RSD<span className="text-xs font-normal text-slate-400">/dan</span></span>
                </div>
              </div>
            </div>
            ...
            <div className="group relative overflow-hidden rounded-2xl bg-white shadow-md transition-all hover:-translate-y-1 hover:shadow-xl">
              <div className="flex h-48 w-full items-center justify-center bg-slate-100 transition-colors group-hover:bg-amber-50">
                <Bike className="h-20 w-20 text-slate-300 group-hover:text-amber-500" strokeWidth={1.5} />
              </div>
              <div className="p-5">
                <div className="mb-2 flex items-start justify-between">
                  <h3 className="font-semibold text-slate-900">Električni trotinet</h3>
                  <span className="rounded-full bg-slate-100 px-2 py-1 text-xs font-bold text-slate-600">Prevoz</span>
                </div>
                <div className="flex items-center gap-2 text-sm text-slate-500">
                  <MapPin className="h-3 w-3" />
                ...
                <div className="mt-4 flex items-center justify-between border-t border-slate-100 pt-4">
                  <div className="flex items-center gap-2">
                    <div className="h-6 w-6 rounded-full bg-slate-200"></div>
                    <span className="text-xs font-medium text-slate-600">Nikola Đ.</span>
                  </div>
                  <span className="font-bold text-amber-600">1200 RSD<span className="text-xs font-normal text-slate-400">/dan</span></span>
                </div>
              </div>
            </div>
          </div>
      ...
      <section id="zasto-deljenje" className="bg-white py-24">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            <h2 className="text-3xl font-bold tracking-tight text-slate-900 sm:text-4xl">Zašto deljenje ima smisla?</h2>
            <p className="mt-4 text-lg text-slate-600">Manje stvari u ormaru, više novca u džepu. I bolji odnos sa komšijama.</p>
          </div>
          ...
          <div className="mt-16 grid grid-cols-1 gap-12 sm:grid-cols-3">
            <div className="flex flex-col items-center text-center">
              ...
              <p className="mt-3 leading-7 text-slate-600">
                Zašto plaćati punu cenu za nešto što ti treba retko? Iznajmljivanje je 10x jeftinije od kupovine.
              </p>
            </div>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <p className="mt-3 leading-7 text-slate-600">
                Jedna bušilica se u proseku koristi samo 13 minuta tokom svog životnog veka. Deljenjem smanjujemo otpad.
              </p>
            </div>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <h3 className="text-xl font-bold text-slate-900">Upoznaj komšije</h3>
              <p className="mt-3 leading-7 text-slate-600">
                Podeli je više od transakcije. To je prilika da upoznaš ljude koji žive oko tebe i izgradiš poverenje.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="bg-slate-900 py-24 text-white">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
            <div>
              <h2 className="text-3xl font-bold tracking-tight sm:text-4xl">Sigurnost je na prvom mestu</h2>
              <p className="mt-6 text-lg text-slate-300">
                Znamo da je poverenje ključno. Zato smo izgradili sistem koji štiti i vlasnike i one koji iznajmljuju.
              </p>
              ...
              <ul className="mt-10 space-y-6">
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    <strong className="block font-semibold text-white">Verifikovani korisnici</strong>
                    <span className="text-slate-400">Svaki nalog prolazi kroz proveru telefona i lokacije.</span>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <ShieldCheck className="h-6 w-6 flex-none text-amber-500" />
                  <div>
                    <strong className="block font-semibold text-white">Ocene i recenzije</strong>
                    <span className="text-slate-400">Vidiš iskustva drugih pre nego što se dogovoriš.</span>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <ShieldCheck className="h-6 w-6 flex-none text-amber-500" />
                  <div>
                    <strong className="block font-semibold text-white">Sigurni dogovori</strong>
                    <span className="text-slate-400">Jasna pravila o korišćenju i vraćanju stvari.</span>
                  </div>
                </li>
              </ul>
            </div>
            ...
            <div className="relative rounded-3xl bg-slate-800 p-8">
              ...
              <blockquote className="space-y-6">
                <p className="text-xl font-medium italic text-slate-200">
                  "Imao sam merdevine koje su stajale u garaži 3 godine. Preko Podeli platforme sam ih iznajmio komšiji za vikend. Ja zaradio za kafu, on završio krečenje, a merdevine konačno služe svrsi."
                </p>
                <div className="flex items-center gap-4">
                  <div className="h-12 w-12 rounded-full bg-slate-600"></div>
                  <div>
                    <div className="font-semibold text-white">Nikola Jovanović</div>
      ...
      <footer className="bg-white py-12">
        <div className="mx-auto max-w-7xl px-6 text-center text-sm text-slate-500 lg:px-8">
          <p>&copy; {new Date().getFullYear()} PODELI.rs - Sva prava zadržana.</p>
          <div className="mt-4 flex justify-center gap-6">
            <a href="#" className="hover:text-slate-900">O nama</a>
            <a href="#" className="hover:text-slate-900">Pravila korišćenja</a>
